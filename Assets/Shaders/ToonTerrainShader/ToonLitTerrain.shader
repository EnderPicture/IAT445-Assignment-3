Shader "Custom/ToonLitTerrain"
{
    Properties
    {
        ...
        _RimWidth("Rim Width", Float) = 0.39
        ...
        _UnderWaterBrightness("Underwater Brightness", Float) = 0.5
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ToonLitTerrainShader"
}
