...
{
    internal class ToonLitTerrainShader : BaseShaderGUI
    {
        // Properties
        ...
        public override void DrawAdditionalFoldouts(Material material)
        {
            ...
            material.SetFloat("_WaterHeight", EditorGUILayout.FloatField("Water Height",material.GetFloat("_WaterHeight")));
            material.SetFloat("_UnderWaterBrightness", EditorGUILayout.FloatField("Under Water Brightness",material.GetFloat("_UnderWaterBrightness")));
        }
